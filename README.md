...
To be used as authentication and access  protected routes for that session.
- [ ] What steps can you take in your web apps to keep your data secure?
Using https when passing creditials to the back end not not using the local storage for sensitive information.

- [ ] Describe how web servers work.
Web Servers are basiclly computers that talk to other computers via DNS.
